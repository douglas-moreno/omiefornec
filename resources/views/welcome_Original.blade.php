...
<head>
    ...
    <title>Exportar Pedidos de Compra</title>
                ...
                <div class="flex gap-4 items-center">
                    <div>
                        ...
                        <input type="date" name="inicial" id="inicial"
                            class="rounded-lg border border-black/10 bg-white px-4 py-2 pr-12 shadow-sm focus:border-[#FF2D20] focus:ring-[#FF2D20] sm:text-sm"
                            value="{{ old('data') }}" />
                    </div>
                    <div>
